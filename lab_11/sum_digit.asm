...
win_name          db    "Counter",0       ; заголовок окна
rel_name          db    "Result", 0
button_name       db    "button",0        ; имя класса кнопки
button_text       db    "sum",0           ; текст на кнопке
...
.ELSEIF uMsg == WM_CREATE
    invoke CreateWindowEx,WS_EX_CLIENTEDGE, ADDR LabelClassName,NULL,\
                          ...
                          ES_AUTOHSCROLL,\
                          50,10,200,25, hwnd, 8, hinstance, NULL
    mov  hwndLabel1,EAX
...
; создание второго поля ввода
    invoke    CreateWindowEx, WS_EX_CLIENTEDGE, addr edit_name,\
        NULL, WS_CHILD or WS_VISIBLE or WS_BORDER or ES_LEFT or\
        ES_AUTOHSCROLL, 50, 70, 200, 25, hwnd, 8, hinstance, NULL
    mov    hwnd_edit2, eax
...
; создание кнопки
    invoke    CreateWindowEx, NULL, addr button_name, addr button_text,\
        ...
        75, 105, 140, 25, hwnd, button_id, hinstance, NULL
    mov    hwnd_button, eax
...
print_result:
            ...
            invoke MessageBox, hwnd, addr buf, addr rel_name, MB_OK
